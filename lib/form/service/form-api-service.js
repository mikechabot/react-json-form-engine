...
var FIELD = _formConst.PROPERTY.FIELD,
    ...
    CALCULATIONS = _formConst.PROPERTY.CALCULATIONS;
...
var FormApiService = {
    ...
    __validateDefinitionShape: function __validateDefinitionShape(definition) {
        var _validator$shape2, _validator$shape3, _validator$shape4, _validator$shape5;

        validator.throw([validator.shape((_validator$shape5 = {}, _defineProperty(_validator$shape5, DEFINITION.ID, validator.string), _defineProperty(_validator$shape5, DEFINITION.TITLE, validator.string), _defineProperty(_validator$shape5, DEFINITION.FA_ICON, validator.object.optional), _defineProperty(_validator$shape5, DEFINITION.SUBTITLE, validator.string.optional), _defineProperty(_validator$shape5, DEFINITION.SECTIONS, validator.arrayOf(validator.shape((_validator$shape3 = {}, _defineProperty(_validator$shape3, SECTION.ID, validator.string), _defineProperty(_validator$shape3, SECTION.TITLE, validator.string), _defineProperty(_validator$shape3, SECTION.SUBTITLE, validator.string.optional), _defineProperty(_validator$shape3, SECTION.SORT_ORDER, validator.number.optional), _defineProperty(_validator$shape3, SECTION.SUBSECTIONS, validator.arrayOf(validator.shape((_validator$shape2 = {}, _defineProperty(_validator$shape2, SUBSECTION.ID, validator.string), _defineProperty(_validator$shape2, SUBSECTION.TITLE, validator.string), _defineProperty(_validator$shape2, SUBSECTION.SUBTITLE, validator.string.optional), _defineProperty(_validator$shape2, SUBSECTION.SORT_ORDER, validator.number.optional), _defineProperty(_validator$shape2, SUBSECTION.FIELDS, validator.arrayOf(validator.object)), _validator$shape2)).strict)), _validator$shape3)).strict)), _defineProperty(_validator$shape5, DEFINITION.DECORATORS, validator.object.optional), _defineProperty(_validator$shape5, DEFINITION.CALCULATIONS, validator.shape((_validator$shape4 = {}, _defineProperty(_validator$shape4, CALCULATIONS.EXPRESSION_MAP, validator.object.optional), _defineProperty(_validator$shape4, CALCULATIONS.TRIGGER_MAP, validator.object.optional), _validator$shape4)).optional), _defineProperty(_validator$shape5, DEFINITION.DEFAULT_VALUE_TRIGGERS, validator.object.optional), _validator$shape5)).strict], arguments, {
