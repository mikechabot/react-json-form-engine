...
var FormEngine = function () {
    ...
    _createClass(FormEngine, [{
        ...
        value: function __hydrateModel(model) {
            var hydratedModel = new _sortableMap2.default();
            (0, _forEach3.default)(model, function (value, key) {
        ...
        key: '__initInstance',
        value: function __initInstance(options) {
        ...
        value: function __cloneSections() {
            ...
            this.getDefinitionSections().forEach(function (section) {
                _this.sections.add(section.id, (0, _common.__clone)(section));
            });
        }
        /**
        ...
        value: function __initFieldMetadata() {
            ...
            this.sections.forEachValue(function (section) {
                section.subsections.forEach(function (subsection) {
                    ...
                    _this2.__decorateFields(subsection.fields);
                    _this2.subsections.add(subsection.id, subsection);
                });
            });
        }
        /**
        ...
        value: function __decorateFields(fields, parent) {
            ...
            (0, _forEach3.default)(fields, function (field) {
                _this3.__decorateField(field, parent);
                if (field.fields) {
                    _this3.__decorateFields(field.fields, field);
                }
                (0, _forEach3.default)(field.options, function (option) {
                    option.parent = field;
                    if (option.fields) {
                        _this3.__decorateFields(option.fields, option);
                    }
                });
            });
        }
        ...
        value: function __registerShowCondition(field) {
            ...
            [expression, expression1, expression2].forEach(function (_expression) {
                if (_expressionService2.default.isFormResponseExpression(_expression)) {
                    var list = _this4.showConditionTriggerMap.find(_expression.id);
                    if (!list) {
                        list = [];
                        _this4.showConditionTriggerMap.add(_expression.id, list);
                    }
        ...
        value: function setModelValue(id, value, field) {
            ...
            (0, _forEach3.default)(field[FIELD.OPTIONS], function (option) {
                if (option[FIELD.FIELDS] && (_this5.isBooleanField(field) && !value || !(0, _includes3.default)(value, option[FIELD.ID]))) {
                    _this5.resetFields(option[FIELD.FIELDS]);
                }
            });
            ...
            if (this.showConditionTriggerMap.has(id)) {
                this.showConditionTriggerMap.find(id).forEach(function (fieldId) {
                    if (_this5.hasModelValue(fieldId) && !_this5.evaluateFieldShowCondition(_this5.getField(fieldId))) {
                        _this5.setModelValue(fieldId, _formConst.NO_VALUE, _this5.getField(fieldId));
                    }
                });
            }
        }
        ...
        value: function resetFields(fields) {
            ...
            (0, _forEach3.default)(fields, function (field) {
                if (_this6.hasModelValue(field[FIELD.ID])) {
                    _this6.setModelValue(field[FIELD.ID], _formConst.NO_VALUE, field);
                }
            });
        }
        /**
        ...
        value: function doResetChildren(field, value) {
            ...
            switch (field[FIELD.TYPE]) {
                ...
                case _formConst.DATA_TYPE.STRING:
                    return (0, _common.__blank)(value);
        ...
        value: function fieldHasError(id) {
            return _validationService2.default.isError(this.getValidationStatusByTag(id));
        }
    }, {
        ...
        value: function __buildFlatFieldList() {
            ...
            if (fields) {
                fields.forEach(function (field) {
                    ...
                    if (field.fields) {
                        _this7.__buildFlatFieldList(list, field.fields);
                    }
                    if (field.options) {
                        field.options.forEach(function (option) {
                            if (option.fields) {
                                _this7.__buildFlatFieldList(list, option.fields);
                            }
                        });
                    }
                });
