    ...
    _createClass(FormEngine, [{
        ...
        value: function getValidationStatusByTag(id, doNotRecurse) {
            ...
            (0, _forEach3.default)(field.fields, function (child, index) {
                var newStatus = _this7.findStatus(field.fields, _this7.getValidationStatusByTag.bind(_this7), true);
        ...
        value: function __buildFlatFieldList() {
            ...
            if (fields) {
                fields.forEach(function (field) {
                    ...
                    if (field.fields) {
                        _this8.__buildFlatFieldList(list, field.fields);
                    }
                    if (field.options) {
                        field.options.forEach(function (option) {
                            if (option.fields) {
                                _this8.__buildFlatFieldList(list, option.fields);
                            }
                        });
                    }
                });
