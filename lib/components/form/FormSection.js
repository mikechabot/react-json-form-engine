...
var FormSection = function (_React$Component) {
    ...
    function FormSection(props) {
        ...
        _this._renderSubsectionTab = _this._renderSubsectionTab.bind(_this);
        return _this;
    }
    ...
    _createClass(FormSection, [{
        ...
        value: function _renderSubsectionTab(subsection, index) {
            return _react2.default.createElement(
                _reactTabify.Tab,
                { key: index, eventKey: index, label: this._getDerivedSubsectionTitle(subsection) },
        ...
        value: function _getDerivedSubsectionTitle(subsection) {
            ...
            if (this.props.instance.subsectionHasError(subsection)) {
                label = _react2.default.createElement(
                    ...
                    label,
                    ' ',
                    _react2.default.createElement(_common.Asterisk, null)
                );
            }
            return label;
        }
...
FormSection.propTypes = {
    ...
    showSubsectionSubmit: _propTypes2.default.bool
};
