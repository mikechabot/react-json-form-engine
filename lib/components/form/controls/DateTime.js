...
var DateTime = function (_React$Component) {
    ...
    _createClass(DateTime, [{
        ...
        value: function render() {
            ...
            var decorators = _maybeBaby2.default.of(field).prop('uiDecorators');

            var props = {};
            if (decorators.isNothing()) {
                props.timeFormat = 'hh:mm A';
                props.dateFormat = 'LLL';
                props = _extends({}, props, __getDefaultTimeProps());
            } else {
            ...
            return _react2.default.createElement(_reactDatepicker2.default, _extends({ id: id, selected: value, onChange: this.onUpdate }, props));
        }
    }]);
