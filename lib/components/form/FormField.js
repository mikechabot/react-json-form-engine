    ...
    _createClass(FormField, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                _common.Flex,
                { column: true, className: 'field', width: '100%' },
                _react2.default.createElement(_FormControl2.default, this.props),
                _react2.default.createElement(_FormChildren2.default, this.props)
            );
        }
    }]);
